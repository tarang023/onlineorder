...
import AddressesSection from "@/app/components/account-history/AddressesSection";
import LoyaltyRewardsSection from '@/app/components/account-history/LoyaltyRewardsSection';
import OrderHistorySection from '@/app/components/account-history/OrderHistorySection';
import PaymentMethodsSection from '@/app/components/account-history/PaymentMethodsSection';
import ProfileSection from '@/app/components/account-history/ProfileSection';

function AccountHistory({initialOrderItems,profile}) {
  ...
  const renderActiveSection = () => {
    switch (activeTab) {
      ...
      case "orders":
        return <OrderHistorySection orders={initialOrderItems}/>;
      case "rewards":
        return (
              ...
              <div className="bg-surface rounded-lg shadow-soft p-6 sticky top-32">
                ...
                <div className="mt-8 pt-6 border-t border-border">
                  ...
                  <div className="space-y-2">
                    <button
                      onClick={() => navigate.push("/menu-browse-search")}
                    ...
                    <button
                     onClick={() => navigate.push("/support-page")}
                    className="w-full flex items-center space-x-3 px-4 py-2 text-text-secondary hover:text-primary hover:bg-primary-50 rounded-lg transition-smooth font-body text-sm">
