...
useEffect(() => {
  ...
  const calculatePointsDiscount = () => {
    return usePoints
      ? Math.min(loyaltyPoints * 0.01, calculateSubtotal() * 0.2)
      : 0;
  };
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center justify-between mt-4">
                            <Link
                              href={`/item-detail-customization?id=${item.id}`} // ✅ FIXED: Pass data via query params
                  ...
                  <div className="space-y-3">
                    ...
                    {usePoints && calculatePointsDiscount() > 0 && (
                      <div className="flex justify-between text-success">
                        ...
                        <span className="font-data font-data-normal">
                          -${calculatePointsDiscount().toFixed(2)}
                        </span>
                      </div>
                    )}
