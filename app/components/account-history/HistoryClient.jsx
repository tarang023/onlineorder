...
function HistoryClient({ initialOrderItems }) {
  ...
  const [orders, setOrders] = useState(initialOrderItems);
useEffect(()=>{
  ...
  return (
    <div className="space-y-6">
      ...
      {filteredOrders?.length === 0 ? (
        <div
          key={filteredOrders._id}
          className="bg-surface rounded-lg shadow-soft p-12 text-center"
        >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-4 mb-2">
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <span
                          className={`px-3 py-1 rounded-full text-sm font-body font-body-medium ${getStatusColor(
                            order?.status
                          )}`}
                        >
